...
export const Header: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      className={`absolute top-0 z-10 flex h-14 w-full flex-row items-center justify-center p-3 overflow-x-auto lg:overflow-x-visible bg-gray-50/80 backdrop-blur-3xl border-b  dark:bg-[#1a1a1a]/80 dark:border-gray-600 data-[istemporary-chat='true']:bg-violet-100/80 data-[istemporary-chat='true']:border-violet-300 data-[istemporary-chat='true']:dark:bg-black/80 data-[istemporary-chat='true']:dark:border-gray-600`}>
